...
const Experience = () => {
  ...
  const experiences = [
    {
      title: "Frontend Development & Project Management Intern",
      company: "Accodyn Technologies",
      location: "",
      period: "Feb 2025 - June 2025",
      description: [
        "Worked across frontend development and project management for NBFC (Non-Banking Financial Company) clients.",
        "Built responsive interfaces and coordinated with cross-functional teams to plan timelines and track deliverables.",
        "Translated business requirements into actionable project plans.",
      ]
    }
  ];
